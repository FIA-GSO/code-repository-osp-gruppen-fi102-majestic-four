        ...
        <main className="h-[calc(100vh-64px)] w-full flex justify-center items-center bg-slate-800">
            <div className="h-full w-full flex flex-col justify-center items-center">
                <div className="flex flex-col justify-center items-center">
                    {changeEmail !== "Wait" && changePassword === "None" && (
                    ...
                    {changeEmail === "Enter" && (
                        <div className="gap-4 mt-10 flex">
                            <button
                                ...
                                disabled={!Boolean(email.match(emailPattern))}
                            >
                        ...
                        <div className="gap-4 mt-10 flex flex-col justify-center items-center">
                            ...
                            <div>
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(0, 1, e.target.value);
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(1, 1, e.target.value);
                                        newCode = newCode.join("");
                                        setCode(newCode);
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(2, 1, e.target.value);
                                        newCode = newCode.join("");
                                        setCode(newCode);
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(3, 1, e.target.value);
                                        newCode = newCode.join("");
                                        setCode(newCode);
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(4, 1, e.target.value);
                                        newCode = newCode.join("");
                                        setCode(newCode);
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        newCode = code.split("");
                                        newCode.splice(5, 1, e.target.value);
                                        newCode = newCode.join("");
                                        setCode(newCode);
                                    }}
                                />
                ...
                {changePassword === "Wait" && (
                    <div className="gap-4 mt-10 flex flex-col justify-center items-center">
                        <div>
                            Geben Sie den Code, der per Email versendet wurde,
                            hier ein!
                        </div>
                        <div>
                            <input
